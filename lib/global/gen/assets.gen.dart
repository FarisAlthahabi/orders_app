...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/introFourth.png
  AssetGenImage get introFourth =>
      const AssetGenImage('assets/images/introFourth.png');

  /// File path: assets/images/introSecond.png
  AssetGenImage get introSecond =>
      const AssetGenImage('assets/images/introSecond.png');

  /// File path: assets/images/introThird.png
  AssetGenImage get introThird =>
      const AssetGenImage('assets/images/introThird.png');
